...
public class TextDefinitionEntity extends ActivityItemDefinitionEntity {

	TextTypeEntity getTextType() {
		return (TextTypeEntity) getActivityItemType();
	}
	...
	public static ActivityItemDefinitionEntity newEntity(ActivityDefinitionEntity activityDefEntity,
		...
		TextDefinitionEntity entity = new TextDefinitionEntity();
