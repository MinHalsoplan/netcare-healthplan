...
<div class="span3 menu">
	<ul class="menuList">
		...
		<li><netcare:image name="result-overview" size="16" /><a id="selectResults" href="<spring:url value="/netcare/user/select-results" />"><spring:message code="patient.menu.results" /></a></li>
	</ul>
</div>
