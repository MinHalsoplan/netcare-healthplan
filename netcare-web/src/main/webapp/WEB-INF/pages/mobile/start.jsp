...
<body>
	<div data-role="page" id="start" data-external-page="true">
		<div data-role="header" id="today-header" data-theme="c" >
			<h1>
			...
			<div data-role="navbar" class="ui-navbar">
				<ul>
					...
					<li><a id="due" href="#" data-icon="alert"><spring:message
								code="mobile.activity.unfinished" /></a></li>
					<li><a id="reported" href="#" data-icon="check"><spring:message
								code="mobile.activity.done" /></a></li>
				</ul>
			</div>
		</div>
		...
		<div id="today-footer" data-role="footer" data-theme="c">
			<h4>
	...
	<div data-role="page" id="report" data-external-page="true">
		<div id="report-header" data-role="header">
			<h1>
				<spring:message code="mobile.report.title" />
			</h1>
		</div>
			...
			<div class="ui-body ui-body-d">
				...
				<form id="reportForm" method="post">
					...
					<div id="slider-div" data-role="fieldcontain">
						<label for="slider" id="slider-label" class="ui-slider ui-input-text"></label> <input type="number"
							data-type="range" name="slider" id="slider" value="5" min="1" max="10"
					...
					<a id="sendReport" href="#" class="ui-btn-active" data-theme="b" data-role="button" data-icon="check"><spring:message
							code="mobile.report.title" /></a> <a id="back" data-rel="back" data-theme="c" data-icon="arrow-l"
						data-role="button"><spring:message code="mobile.back" /></a>
				</form>
			</div>
		</div>
		<div id="report-footer" data-role="footer">
			<h4>
				<sec:authentication property="principal.name" />
			</h4>
		</div>
